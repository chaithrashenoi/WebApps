...
public class ShowBrand extends HttpServlet {
	...
	public void doGet(HttpServletRequest request,
		...
		int count = fetchVendorProductInfo(Vendor, request);
	...
	private int fetchVendorProductInfo(String Vendor, HttpServletRequest request) {
		...
		try {
			...
			String query = "SELECT manufacturers_id, product3.sku, cost, product_image, on_hand3.quantity " +
      "FROM product3 " +
       "LEFT OUTER JOIN on_hand3 ON on_hand3.sku = product3.sku " +
       "WHERE vendor_description= \"" + Vendor + "\"";
